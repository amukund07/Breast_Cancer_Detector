...
FEATURES = pickle.load(open("features.pkl", "rb"))  # exact training order
    ...
    if request.method == "POST":
        try:
            ...
            if pred == 1:
                ...
                message = (
                    "The model indicates a higher risk pattern. "
                    "This does NOT confirm cancer. "
                ...
                message = (
                    "The model indicates a lower risk pattern. "
                    "Continue regular check-ups and consult a doctor if symptoms appear."
                )
